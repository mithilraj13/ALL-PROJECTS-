                        ...
                        <div className="row justify-content-center">
                          ...
                          <div className="col-md-4 col-12 mt-3">
                            ...
                            <input
                              ...
                              value={serumferritin}
                              onChange={(e) => setSerumferritin(e.target.value)}
                            />
                          </div>
                          <div className="col-md-4 col-12 mt-3">
                        ...
                        <div className="card">
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                Dark-green leafy vegetables like watercress and
                                curly kale.
                                <br />
                          ...
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                ...
                                <br /> Avoiding supplements that contain vitamin
                                C, as this vitamin increases iron absorption.
                          ...
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                ...
                                <br />
                                Seeds. Seeds are a healthy addition to your diet
                                and can help increase your zinc intake. <br />
                                Nuts. <br />
                                Dairy. <br />
                                Eggs. <br />
                                Whole Grains.
                      ...
                      <div className="col-md-6 mt-3">
                        <div className="card">
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                The calcium and phosphorus in the milk can help
                                bind the excess zinc and prevent the stomach and
                                intestines from absorbing it.
                                <br /> Chelation is a process that removes
                                excess metals, such as zinc, copper, or lead,
                                from the body.
                                <br /> During this treatment, a doctor gives the
                                person a drug that helps bind the excess zinc
                          ...
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                Exercise
                                <br /> Iodine
                                <br /> A healthy and balanced diet consisting of
                                whole grains, seafood, good amounts of high
                                quality protein and fiber can help raise TSH
                                levels naturally.
                                <br /> The mineral, selenium plays an important
                                role in thyroid activity.
                                ...
                                tenderloin, calf’s liver, should be included in
                                the regular diet.
                                <br />
                                Consumption of low glycemic foods helps control
                                blood sugar levels.
                                <br /> Stable blood sugar levels promote proper
                                functioning of the glands in the body.
                                <br /> Certain foods and supplements can worsen
                                the situation.
                                <br /> Avoid refined carbohydrates which lead to
                                weight gain. <br />
                          ...
                          <div className="card-body">
                            ...
                            <div className="card-body text-start text-white">
                              <p>
                                ...
                                food.
                                <br /> Include lots of vitamin B-rich foods like
                                nuts and seeds.
                                <br /> Drinking plenty of water, and including
                                salt high in iodine will also benefit.
                                <br /> Avoid the consumption of alcohol and also
                                avoid smoking.
                              </p>
                            </div>
                          </div>
